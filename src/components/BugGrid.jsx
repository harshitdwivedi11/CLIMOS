        ...
        <div key={bug.id} className="bg-white rounded-lg border shadow-sm p-3 sm:p-4">
          <div className="flex items-start justify-between mb-2">
            <div className="flex-1 pr-3 sm:pr-4">
              <h3 className="text-sm sm:text-base font-medium text-gray-900 mb-1">{bug.title}</h3>
              <p className="text-xs sm:text-sm text-gray-500 line-clamp-2">{bug.description}</p>
            </div>
